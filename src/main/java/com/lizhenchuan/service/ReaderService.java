...
public interface ReaderService {
    ...
    public void updateemail(Long rid,String email); //修改用户邮箱
    public void updateaddress(Long rid,String address); //修改用户联系地址
    public void updatephone(Long rid,String phone); //修改用户电话
    public void deletereader(Long rid); //删除读者
